    ...
    <div className="min-h-screen bg-ivory py-6 px-4">
      <div className="max-w-2xl mx-auto bg-ivory-light border border-ink/10 rounded-sm overflow-hidden">
        ...
        <main>
          ...
          <div className="px-7 py-8 border-b border-ink/8">
            <p className="font-sans text-[11px] text-burnt tracking-[3px] mb-3">
              CONCEPT
            </p>
            <p
          ...
          <div className="px-7 py-8 grid grid-cols-2 gap-8">
            <div>
