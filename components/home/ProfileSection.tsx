...
export function ProfileSection() {
  return (
    <section className="px-7 py-8 grid grid-cols-[80px_1fr] gap-[18px] items-start">
      <div className="w-20 h-20 bg-burnt rounded-full flex items-center justify-center shrink-0">
        <span
